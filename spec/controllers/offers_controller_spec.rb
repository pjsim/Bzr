  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved offer as @offer" do
        ...
        post :create, {:offer => { "product" => "invalid value" }}, valid_session
        assigns(:offer).should be_a_new(Offer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested offer" do
        ...
        Offer.any_instance.should_receive(:update).with({ "product" => "" })
        put :update, {:id => offer.to_param, :offer => { "product" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the offer as @offer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Offer.any_instance.stub(:save).and_return(false)
        put :update, {:id => offer.to_param, :offer => { "product" => "invalid value" }}, valid_session
        assigns(:offer).should eq(offer)
      end
